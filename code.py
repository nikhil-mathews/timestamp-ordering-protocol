...
if __name__ == '__main__':
    # MAIN
    #string ='st1; st2; st3;r2(x);r1(x);w2(x);w3(x);w1(x);c1;w3(x);a4;r2(y);w2(y);r3(y);c2;w3(y);c3'
    #string = 'st1; st2; w1(A); r2(B); w1(B)'
    ...
    while (string):
        ...
        print("\nCommand: " + str(next_item) + ". Remaining commands:" + str(string))
        ...
        if next_item[:2] == 'st':
            ...
            if not trans(id):
                ...
                time += 1
                print("Added " + id + " to set_of_trans")
            else:
                print("Transaction " + id + " exists in set_of_trans ")
            ...
            if not T_i:
                ...
                if not params(p):
                    ...
                    if (var.w_time > T_i.time):
                        ...
                        print("Read time of " + var.name + " changed from " + str(o) + " to " + str(var.r_time))
            ...
            if not T_i:
                ...
                if not params(p):
                    ...
                    if (var.r_time > T_i.time):
                        ...
                        print("Ignore " + next_item + " by Thomas write rule. Trans:" + T_i.name)

                    else:
                        print("Execute " + next_item + " in " + T_i.name)
                        o = var.w_time
                        var.w_time = T_i.time
                        print("Write time of " + var.name + " changed from " + str(o) + " to " + str(var.w_time))
